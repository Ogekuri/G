...
# core.py | Python | 3093L | 186 symbols | 16 imports | 818 comments
...
### fn `def _format_changelog_description(desc: str) -> str` `priv` (L1027-1035)
...
### fn `def categorize_commit(subject: str) -> Tuple[Optional[str], str]` (L1042-1067)
...
### fn `def _extract_release_version(subject: str) -> Optional[str]` `priv` (L1072-1082)
...
### fn `def _is_release_marker_commit(subject: str) -> bool` `priv` (L1087-1090)
...
### fn `def generate_section_for_range(repo_root: Path, title: str, date_s: str, rev_range: str, expected_version: Optional[str] = None) -> Optional[str]` (L1099-1137)
...
### fn `def _get_remote_name_for_branch(branch_name: str, repo_root: Path) -> str` `priv` (L1146-1154)
...
### fn `def _extract_owner_repo(remote_url: str) -> Optional[Tuple[str, str]]` `priv` (L1161-1185)
...
### fn `def _canonical_origin_base(repo_root: Path) -> Optional[str]` `priv` (L1195-1208)
...
### fn `def get_origin_compare_url(base_url: Optional[str], prev_tag: Optional[str], tag: str) -> Optional[str]` (L1215-1222)
...
### fn `def get_release_page_url(base_url: Optional[str], tag: str) -> Optional[str]` (L1228-1233)
...
### fn `def build_history_section(` (L1241-1245)
...
### fn `def generate_changelog_document(repo_root: Path, include_patch: bool, disable_history: bool = False) -> str` (L1289-1350)
...
### class `class VersionRuleContext` `@dataclass(frozen=True)` (L1361-1368)

### fn `def _normalize_version_rule_pattern(pattern: str) -> str` `priv` (L1374-1385)
...
### fn `def _build_version_file_inventory(root: Path) -> List[Tuple[Path, str]]` `priv` (L1391-1412)
...
### fn `def _collect_version_files(root, pattern, *, inventory=None)` `priv` (L1420-1437)
...
### fn `def _is_version_path_excluded(relative_path: str) -> bool` `priv` (L1442-1445)
...
### fn `def _iter_versions_in_text(text, compiled_regexes)` `priv` (L1451-1462)
...
### fn `def _read_version_file_text(file_path: Path, text_cache: Optional[Dict[Path, str]] = None) -> Optional[str]` `priv` (L1469-1483)
...
### fn `def _prepare_version_rule_contexts(` `priv` (L1492-1493)
...
### fn `def _determine_canonical_version(` `priv` (L1535-1542)
...
### fn `def _parse_semver_tuple(text: str) -> Optional[Tuple[int, int, int]]` `priv` (L1587-1593)
...
### fn `def _replace_versions_in_text(text, compiled_regex, replacement)` `priv` (L1600-1615)
...
### fn `def _current_branch_name()` `priv` (L1619-1631)
...
### fn `def _ref_exists(ref_name)` `priv` (L1636-1645)
...
### fn `def _local_branch_exists(branch_name)` `priv` (L1650-1653)
...
### fn `def _remote_branch_exists(branch_name)` `priv` (L1658-1661)
...
### fn `def _ensure_release_prerequisites()` `priv` (L1665-1692)
...
### fn `def _bump_semver_version(current_version, level)` `priv` (L1698-1716)
...
### fn `def _run_release_step(level, step_name, action)` `priv` (L1723-1743)
...
### fn `def _create_release_commit_for_flow(target_version)` `priv` (L1748-1753)
...
### fn `def _push_branch_with_tags(branch_name)` `priv` (L1759-1763)
...
### fn `def _execute_release_flow(level, changelog_args=None)` `priv` (L1779-1826)
...
### fn `def _execute_backup_flow()` `priv` (L1834-1849)
...
### fn `def _run_release_command(level, changelog_args=None)` `priv` (L1855-1870)
...
### fn `def _run_backup_command()` `priv` (L1875-1882)
...
### fn `def _run_reset_with_help(base_args, extra)` `priv` (L1888-1895)
...
### fn `def _reject_extra_arguments(extra, alias)` `priv` (L1901-1907)
...
### fn `def _parse_release_flags(extra, alias)` `priv` (L1913-1931)
...
### fn `def _prepare_commit_message(extra, alias)` `priv` (L1937-1947)
...
### fn `def _build_conventional_message(kind: str, extra, alias: str) -> str` `priv` (L1954-1968)
...
### fn `def _run_conventional_commit(kind: str, alias: str, extra)` `priv` (L1975-1980)
...
### fn `def _execute_commit(message, alias, allow_amend=True)` `priv` (L1987-2016)
...
### fn `def upgrade_self()` (L2020-2033)
...
### fn `def cmd_aa(extra)` (L2045-2052)
...
### fn `def cmd_ra(extra)` (L2057-2080)
...
### fn `def cmd_ar(extra)` (L2085-2099)
...
### fn `def cmd_br(extra)` (L2104-2107)
...
### fn `def cmd_bd(extra)` (L2112-2115)
...
### fn `def cmd_ck(extra)` (L2120-2123)
...
### fn `def _ensure_commit_ready(alias)` `priv` (L2128-2141)
...
### fn `def cmd_cm(extra)` (L2146-2151)
...
### fn `def cmd_wip(extra)` (L2156-2168)
...
### fn `def cmd_release(extra)` (L2173-2195)
...
### fn `def cmd_new(extra)` (L2200-2203)
...
### fn `def cmd_refactor(extra)` (L2208-2211)
...
### fn `def cmd_fix(extra)` (L2216-2219)
...
### fn `def cmd_change(extra)` (L2224-2227)
...
### fn `def cmd_implement(extra)` (L2232-2235)
...
### fn `def cmd_docs(extra)` (L2240-2243)
...
### fn `def cmd_style(extra)` (L2248-2251)
...
### fn `def cmd_revert(extra)` (L2256-2259)
...
### fn `def cmd_misc(extra)` (L2264-2267)
...
### fn `def cmd_cover(extra)` (L2272-2275)
...
### fn `def cmd_co(extra)` (L2280-2283)
...
### fn `def cmd_dcc(extra)` (L2300-2303)
...
### fn `def cmd_dccc(extra)` (L2308-2311)
...
### fn `def cmd_de(extra)` (L2316-2319)
...
### fn `def cmd_di(extra)` (L2324-2327)
...
### fn `def cmd_diyou(extra)` (L2332-2335)
...
### fn `def cmd_dime(extra)` (L2340-2343)
...
### fn `def cmd_dwc(extra)` (L2348-2351)
...
### fn `def cmd_dwcc(extra)` (L2356-2359)
...
### fn `def cmd_ed(extra)` (L2364-2373)
...
### fn `def cmd_fe(extra)` (L2378-2381)
...
### fn `def cmd_feall(extra)` (L2386-2389)
...
### fn `def cmd_gp(extra)` (L2394-2397)
...
### fn `def cmd_gr(extra)` (L2402-2405)
...
### fn `def cmd_str(extra)` (L2410-2439)
...
### fn `def cmd_lb(extra)` (L2444-2447)
...
### fn `def cmd_lg(extra)` (L2452-2465)
...
### fn `def cmd_lh(extra)` (L2470-2473)
...
### fn `def cmd_ll(extra)` (L2478-2490)
...
### fn `def cmd_lm(extra)` (L2495-2498)
...
### fn `def cmd_lt(extra)` (L2504-2523)
...
### fn `def cmd_me(extra)` (L2528-2531)
...
### fn `def cmd_pl(extra)` (L2536-2539)
...
### fn `def cmd_pt(extra)` (L2544-2547)
...
### fn `def cmd_pu(extra)` (L2552-2555)
...
### fn `def cmd_rf(extra)` (L2560-2563)
...
### fn `def cmd_rmtg(extra)` (L2568-2578)
...
### fn `def cmd_rmloc(extra)` (L2583-2586)
...
### fn `def cmd_rmstg(extra)` (L2591-2594)
...
### fn `def cmd_rmunt(extra)` (L2599-2602)
...
### fn `def cmd_rs(extra)` (L2607-2610)
...
### fn `def cmd_rssft(extra)` (L2615-2618)
...
### fn `def cmd_rsmix(extra)` (L2623-2626)
...
### fn `def cmd_rshrd(extra)` (L2631-2634)
...
### fn `def cmd_rsmrg(extra)` (L2639-2642)
...
### fn `def cmd_rskep(extra)` (L2647-2650)
...
### fn `def cmd_st(extra)` (L2655-2658)
...
### fn `def cmd_tg(extra)` (L2663-2666)
...
### fn `def cmd_unstg(extra)` (L2671-2674)
...
### fn `def cmd_wt(extra)` (L2679-2682)
...
### fn `def cmd_wtl(extra)` (L2687-2690)
...
### fn `def cmd_wtp(extra)` (L2695-2698)
...
### fn `def cmd_wtr(extra)` (L2703-2706)
...
### fn `def cmd_ver(extra)` (L2711-2737)
...
### fn `def cmd_chver(extra)` (L2742-2814)
...
### fn `def cmd_major(extra)` (L2823-2827)
...
### fn `def cmd_minor(extra)` (L2836-2840)
...
### fn `def cmd_patch(extra)` (L2849-2853)
...
### fn `def cmd_backup(extra)` (L2861-2871)
...
### fn `def cmd_changelog(extra)` (L2881-2913)
...
### fn `def print_command_help(name, width=None)` (L2993-2999)
...
### fn `def print_all_help()` (L3003-3037)
...
### fn `def main(argv=None, *, check_updates: bool = True)` (L3043-3093)
...
|`_format_changelog_description`|fn|priv|1027-1035|def _format_changelog_description(desc: str) -> str|
|`categorize_commit`|fn|pub|1042-1067|def categorize_commit(subject: str) -> Tuple[Optional[str...|
|`_extract_release_version`|fn|priv|1072-1082|def _extract_release_version(subject: str) -> Optional[str]|
|`_is_release_marker_commit`|fn|priv|1087-1090|def _is_release_marker_commit(subject: str) -> bool|
|`generate_section_for_range`|fn|pub|1099-1137|def generate_section_for_range(repo_root: Path, title: st...|
|`_get_remote_name_for_branch`|fn|priv|1146-1154|def _get_remote_name_for_branch(branch_name: str, repo_ro...|
|`_extract_owner_repo`|fn|priv|1161-1185|def _extract_owner_repo(remote_url: str) -> Optional[Tupl...|
|`_canonical_origin_base`|fn|priv|1195-1208|def _canonical_origin_base(repo_root: Path) -> Optional[str]|
|`get_origin_compare_url`|fn|pub|1215-1222|def get_origin_compare_url(base_url: Optional[str], prev_...|
|`get_release_page_url`|fn|pub|1228-1233|def get_release_page_url(base_url: Optional[str], tag: st...|
|`build_history_section`|fn|pub|1241-1245|def build_history_section(|
|`generate_changelog_document`|fn|pub|1289-1350|def generate_changelog_document(repo_root: Path, include_...|
|`VersionRuleContext`|class|pub|1361-1368|class VersionRuleContext|
|`_normalize_version_rule_pattern`|fn|priv|1374-1385|def _normalize_version_rule_pattern(pattern: str) -> str|
|`_build_version_file_inventory`|fn|priv|1391-1412|def _build_version_file_inventory(root: Path) -> List[Tup...|
|`_collect_version_files`|fn|priv|1420-1437|def _collect_version_files(root, pattern, *, inventory=None)|
|`_is_version_path_excluded`|fn|priv|1442-1445|def _is_version_path_excluded(relative_path: str) -> bool|
|`_iter_versions_in_text`|fn|priv|1451-1462|def _iter_versions_in_text(text, compiled_regexes)|
|`_read_version_file_text`|fn|priv|1469-1483|def _read_version_file_text(file_path: Path, text_cache: ...|
|`_prepare_version_rule_contexts`|fn|priv|1492-1493|def _prepare_version_rule_contexts(|
|`_determine_canonical_version`|fn|priv|1535-1542|def _determine_canonical_version(|
|`_parse_semver_tuple`|fn|priv|1587-1593|def _parse_semver_tuple(text: str) -> Optional[Tuple[int,...|
|`_replace_versions_in_text`|fn|priv|1600-1615|def _replace_versions_in_text(text, compiled_regex, repla...|
|`_current_branch_name`|fn|priv|1619-1631|def _current_branch_name()|
|`_ref_exists`|fn|priv|1636-1645|def _ref_exists(ref_name)|
|`_local_branch_exists`|fn|priv|1650-1653|def _local_branch_exists(branch_name)|
|`_remote_branch_exists`|fn|priv|1658-1661|def _remote_branch_exists(branch_name)|
|`_ensure_release_prerequisites`|fn|priv|1665-1692|def _ensure_release_prerequisites()|
|`_bump_semver_version`|fn|priv|1698-1716|def _bump_semver_version(current_version, level)|
|`_run_release_step`|fn|priv|1723-1743|def _run_release_step(level, step_name, action)|
|`_create_release_commit_for_flow`|fn|priv|1748-1753|def _create_release_commit_for_flow(target_version)|
|`_push_branch_with_tags`|fn|priv|1759-1763|def _push_branch_with_tags(branch_name)|
|`_execute_release_flow`|fn|priv|1779-1826|def _execute_release_flow(level, changelog_args=None)|
|`_execute_backup_flow`|fn|priv|1834-1849|def _execute_backup_flow()|
|`_run_release_command`|fn|priv|1855-1870|def _run_release_command(level, changelog_args=None)|
|`_run_backup_command`|fn|priv|1875-1882|def _run_backup_command()|
|`_run_reset_with_help`|fn|priv|1888-1895|def _run_reset_with_help(base_args, extra)|
|`_reject_extra_arguments`|fn|priv|1901-1907|def _reject_extra_arguments(extra, alias)|
|`_parse_release_flags`|fn|priv|1913-1931|def _parse_release_flags(extra, alias)|
|`_prepare_commit_message`|fn|priv|1937-1947|def _prepare_commit_message(extra, alias)|
|`_build_conventional_message`|fn|priv|1954-1968|def _build_conventional_message(kind: str, extra, alias: ...|
|`_run_conventional_commit`|fn|priv|1975-1980|def _run_conventional_commit(kind: str, alias: str, extra)|
|`_execute_commit`|fn|priv|1987-2016|def _execute_commit(message, alias, allow_amend=True)|
|`upgrade_self`|fn|pub|2020-2033|def upgrade_self()|
|`remove_self`|fn|pub|2037-2040|def remove_self()|
|`cmd_aa`|fn|pub|2045-2052|def cmd_aa(extra)|
|`cmd_ra`|fn|pub|2057-2080|def cmd_ra(extra)|
|`cmd_ar`|fn|pub|2085-2099|def cmd_ar(extra)|
|`cmd_br`|fn|pub|2104-2107|def cmd_br(extra)|
|`cmd_bd`|fn|pub|2112-2115|def cmd_bd(extra)|
|`cmd_ck`|fn|pub|2120-2123|def cmd_ck(extra)|
|`_ensure_commit_ready`|fn|priv|2128-2141|def _ensure_commit_ready(alias)|
|`cmd_cm`|fn|pub|2146-2151|def cmd_cm(extra)|
|`cmd_wip`|fn|pub|2156-2168|def cmd_wip(extra)|
|`cmd_release`|fn|pub|2173-2195|def cmd_release(extra)|
|`cmd_new`|fn|pub|2200-2203|def cmd_new(extra)|
|`cmd_refactor`|fn|pub|2208-2211|def cmd_refactor(extra)|
|`cmd_fix`|fn|pub|2216-2219|def cmd_fix(extra)|
|`cmd_change`|fn|pub|2224-2227|def cmd_change(extra)|
|`cmd_implement`|fn|pub|2232-2235|def cmd_implement(extra)|
|`cmd_docs`|fn|pub|2240-2243|def cmd_docs(extra)|
|`cmd_style`|fn|pub|2248-2251|def cmd_style(extra)|
|`cmd_revert`|fn|pub|2256-2259|def cmd_revert(extra)|
|`cmd_misc`|fn|pub|2264-2267|def cmd_misc(extra)|
|`cmd_cover`|fn|pub|2272-2275|def cmd_cover(extra)|
|`cmd_co`|fn|pub|2280-2283|def cmd_co(extra)|
|`cmd_d`|fn|pub|2288-2295|def cmd_d(extra)|
|`cmd_dcc`|fn|pub|2300-2303|def cmd_dcc(extra)|
|`cmd_dccc`|fn|pub|2308-2311|def cmd_dccc(extra)|
|`cmd_de`|fn|pub|2316-2319|def cmd_de(extra)|
|`cmd_di`|fn|pub|2324-2327|def cmd_di(extra)|
|`cmd_diyou`|fn|pub|2332-2335|def cmd_diyou(extra)|
|`cmd_dime`|fn|pub|2340-2343|def cmd_dime(extra)|
|`cmd_dwc`|fn|pub|2348-2351|def cmd_dwc(extra)|
|`cmd_dwcc`|fn|pub|2356-2359|def cmd_dwcc(extra)|
|`cmd_ed`|fn|pub|2364-2373|def cmd_ed(extra)|
|`cmd_fe`|fn|pub|2378-2381|def cmd_fe(extra)|
|`cmd_feall`|fn|pub|2386-2389|def cmd_feall(extra)|
|`cmd_gp`|fn|pub|2394-2397|def cmd_gp(extra)|
|`cmd_gr`|fn|pub|2402-2405|def cmd_gr(extra)|
|`cmd_str`|fn|pub|2410-2439|def cmd_str(extra)|
|`cmd_lb`|fn|pub|2444-2447|def cmd_lb(extra)|
|`cmd_lg`|fn|pub|2452-2465|def cmd_lg(extra)|
|`cmd_lh`|fn|pub|2470-2473|def cmd_lh(extra)|
|`cmd_ll`|fn|pub|2478-2490|def cmd_ll(extra)|
|`cmd_lm`|fn|pub|2495-2498|def cmd_lm(extra)|
|`cmd_lt`|fn|pub|2504-2523|def cmd_lt(extra)|
|`cmd_me`|fn|pub|2528-2531|def cmd_me(extra)|
|`cmd_pl`|fn|pub|2536-2539|def cmd_pl(extra)|
|`cmd_pt`|fn|pub|2544-2547|def cmd_pt(extra)|
|`cmd_pu`|fn|pub|2552-2555|def cmd_pu(extra)|
|`cmd_rf`|fn|pub|2560-2563|def cmd_rf(extra)|
|`cmd_rmtg`|fn|pub|2568-2578|def cmd_rmtg(extra)|
|`cmd_rmloc`|fn|pub|2583-2586|def cmd_rmloc(extra)|
|`cmd_rmstg`|fn|pub|2591-2594|def cmd_rmstg(extra)|
|`cmd_rmunt`|fn|pub|2599-2602|def cmd_rmunt(extra)|
|`cmd_rs`|fn|pub|2607-2610|def cmd_rs(extra)|
|`cmd_rssft`|fn|pub|2615-2618|def cmd_rssft(extra)|
|`cmd_rsmix`|fn|pub|2623-2626|def cmd_rsmix(extra)|
|`cmd_rshrd`|fn|pub|2631-2634|def cmd_rshrd(extra)|
|`cmd_rsmrg`|fn|pub|2639-2642|def cmd_rsmrg(extra)|
|`cmd_rskep`|fn|pub|2647-2650|def cmd_rskep(extra)|
|`cmd_st`|fn|pub|2655-2658|def cmd_st(extra)|
|`cmd_tg`|fn|pub|2663-2666|def cmd_tg(extra)|
|`cmd_unstg`|fn|pub|2671-2674|def cmd_unstg(extra)|
|`cmd_wt`|fn|pub|2679-2682|def cmd_wt(extra)|
|`cmd_wtl`|fn|pub|2687-2690|def cmd_wtl(extra)|
|`cmd_wtp`|fn|pub|2695-2698|def cmd_wtp(extra)|
|`cmd_wtr`|fn|pub|2703-2706|def cmd_wtr(extra)|
|`cmd_ver`|fn|pub|2711-2737|def cmd_ver(extra)|
|`cmd_chver`|fn|pub|2742-2814|def cmd_chver(extra)|
|`cmd_major`|fn|pub|2823-2827|def cmd_major(extra)|
|`cmd_minor`|fn|pub|2836-2840|def cmd_minor(extra)|
|`cmd_patch`|fn|pub|2849-2853|def cmd_patch(extra)|
|`cmd_backup`|fn|pub|2861-2871|def cmd_backup(extra)|
|`cmd_changelog`|fn|pub|2881-2913|def cmd_changelog(extra)|
|`COMMANDS`|var|pub|2916||
|`print_command_help`|fn|pub|2993-2999|def print_command_help(name, width=None)|
|`print_all_help`|fn|pub|3003-3037|def print_all_help()|
|`main`|fn|pub|3043-3093|def main(argv=None, *, check_updates: bool = True)|
