...
# core.py | Python | 3092L | 186 symbols | 16 imports | 818 comments
...
### fn `def _format_changelog_description(desc: str) -> str` `priv` (L1027-1034)
...
### fn `def categorize_commit(subject: str) -> Tuple[Optional[str], str]` (L1041-1066)
...
### fn `def _extract_release_version(subject: str) -> Optional[str]` `priv` (L1071-1081)
...
### fn `def _is_release_marker_commit(subject: str) -> bool` `priv` (L1086-1089)
...
### fn `def generate_section_for_range(repo_root: Path, title: str, date_s: str, rev_range: str, expected_version: Optional[str] = None) -> Optional[str]` (L1098-1136)
...
### fn `def _get_remote_name_for_branch(branch_name: str, repo_root: Path) -> str` `priv` (L1145-1153)
...
### fn `def _extract_owner_repo(remote_url: str) -> Optional[Tuple[str, str]]` `priv` (L1160-1184)
...
### fn `def _canonical_origin_base(repo_root: Path) -> Optional[str]` `priv` (L1194-1207)
...
### fn `def get_origin_compare_url(base_url: Optional[str], prev_tag: Optional[str], tag: str) -> Optional[str]` (L1214-1221)
...
### fn `def get_release_page_url(base_url: Optional[str], tag: str) -> Optional[str]` (L1227-1232)
...
### fn `def build_history_section(` (L1240-1244)
...
### fn `def generate_changelog_document(repo_root: Path, include_patch: bool, disable_history: bool = False) -> str` (L1288-1349)
...
### class `class VersionRuleContext` `@dataclass(frozen=True)` (L1360-1367)

### fn `def _normalize_version_rule_pattern(pattern: str) -> str` `priv` (L1373-1384)
...
### fn `def _build_version_file_inventory(root: Path) -> List[Tuple[Path, str]]` `priv` (L1390-1411)
...
### fn `def _collect_version_files(root, pattern, *, inventory=None)` `priv` (L1419-1436)
...
### fn `def _is_version_path_excluded(relative_path: str) -> bool` `priv` (L1441-1444)
...
### fn `def _iter_versions_in_text(text, compiled_regexes)` `priv` (L1450-1461)
...
### fn `def _read_version_file_text(file_path: Path, text_cache: Optional[Dict[Path, str]] = None) -> Optional[str]` `priv` (L1468-1482)
...
### fn `def _prepare_version_rule_contexts(` `priv` (L1491-1492)
...
### fn `def _determine_canonical_version(` `priv` (L1534-1541)
...
### fn `def _parse_semver_tuple(text: str) -> Optional[Tuple[int, int, int]]` `priv` (L1586-1592)
...
### fn `def _replace_versions_in_text(text, compiled_regex, replacement)` `priv` (L1599-1614)
...
### fn `def _current_branch_name()` `priv` (L1618-1630)
...
### fn `def _ref_exists(ref_name)` `priv` (L1635-1644)
...
### fn `def _local_branch_exists(branch_name)` `priv` (L1649-1652)
...
### fn `def _remote_branch_exists(branch_name)` `priv` (L1657-1660)
...
### fn `def _ensure_release_prerequisites()` `priv` (L1664-1691)
...
### fn `def _bump_semver_version(current_version, level)` `priv` (L1697-1715)
...
### fn `def _run_release_step(level, step_name, action)` `priv` (L1722-1742)
...
### fn `def _create_release_commit_for_flow(target_version)` `priv` (L1747-1752)
...
### fn `def _push_branch_with_tags(branch_name)` `priv` (L1758-1762)
...
### fn `def _execute_release_flow(level, changelog_args=None)` `priv` (L1778-1825)
...
### fn `def _execute_backup_flow()` `priv` (L1833-1848)
...
### fn `def _run_release_command(level, changelog_args=None)` `priv` (L1854-1869)
...
### fn `def _run_backup_command()` `priv` (L1874-1881)
...
### fn `def _run_reset_with_help(base_args, extra)` `priv` (L1887-1894)
...
### fn `def _reject_extra_arguments(extra, alias)` `priv` (L1900-1906)
...
### fn `def _parse_release_flags(extra, alias)` `priv` (L1912-1930)
...
### fn `def _prepare_commit_message(extra, alias)` `priv` (L1936-1946)
...
### fn `def _build_conventional_message(kind: str, extra, alias: str) -> str` `priv` (L1953-1967)
...
### fn `def _run_conventional_commit(kind: str, alias: str, extra)` `priv` (L1974-1979)
...
### fn `def _execute_commit(message, alias, allow_amend=True)` `priv` (L1986-2015)
...
### fn `def upgrade_self()` (L2019-2032)
...
### fn `def cmd_aa(extra)` (L2044-2051)
...
### fn `def cmd_ra(extra)` (L2056-2079)
...
### fn `def cmd_ar(extra)` (L2084-2098)
...
### fn `def cmd_br(extra)` (L2103-2106)
...
### fn `def cmd_bd(extra)` (L2111-2114)
...
### fn `def cmd_ck(extra)` (L2119-2122)
...
### fn `def _ensure_commit_ready(alias)` `priv` (L2127-2140)
...
### fn `def cmd_cm(extra)` (L2145-2150)
...
### fn `def cmd_wip(extra)` (L2155-2167)
...
### fn `def cmd_release(extra)` (L2172-2194)
...
### fn `def cmd_new(extra)` (L2199-2202)
...
### fn `def cmd_refactor(extra)` (L2207-2210)
...
### fn `def cmd_fix(extra)` (L2215-2218)
...
### fn `def cmd_change(extra)` (L2223-2226)
...
### fn `def cmd_implement(extra)` (L2231-2234)
...
### fn `def cmd_docs(extra)` (L2239-2242)
...
### fn `def cmd_style(extra)` (L2247-2250)
...
### fn `def cmd_revert(extra)` (L2255-2258)
...
### fn `def cmd_misc(extra)` (L2263-2266)
...
### fn `def cmd_cover(extra)` (L2271-2274)
...
### fn `def cmd_co(extra)` (L2279-2282)
...
### fn `def cmd_dcc(extra)` (L2299-2302)
...
### fn `def cmd_dccc(extra)` (L2307-2310)
...
### fn `def cmd_de(extra)` (L2315-2318)
...
### fn `def cmd_di(extra)` (L2323-2326)
...
### fn `def cmd_diyou(extra)` (L2331-2334)
...
### fn `def cmd_dime(extra)` (L2339-2342)
...
### fn `def cmd_dwc(extra)` (L2347-2350)
...
### fn `def cmd_dwcc(extra)` (L2355-2358)
...
### fn `def cmd_ed(extra)` (L2363-2372)
...
### fn `def cmd_fe(extra)` (L2377-2380)
...
### fn `def cmd_feall(extra)` (L2385-2388)
...
### fn `def cmd_gp(extra)` (L2393-2396)
...
### fn `def cmd_gr(extra)` (L2401-2404)
...
### fn `def cmd_str(extra)` (L2409-2438)
...
### fn `def cmd_lb(extra)` (L2443-2446)
...
### fn `def cmd_lg(extra)` (L2451-2464)
...
### fn `def cmd_lh(extra)` (L2469-2472)
...
### fn `def cmd_ll(extra)` (L2477-2489)
...
### fn `def cmd_lm(extra)` (L2494-2497)
...
### fn `def cmd_lt(extra)` (L2503-2522)
...
### fn `def cmd_me(extra)` (L2527-2530)
...
### fn `def cmd_pl(extra)` (L2535-2538)
...
### fn `def cmd_pt(extra)` (L2543-2546)
...
### fn `def cmd_pu(extra)` (L2551-2554)
...
### fn `def cmd_rf(extra)` (L2559-2562)
...
### fn `def cmd_rmtg(extra)` (L2567-2577)
...
### fn `def cmd_rmloc(extra)` (L2582-2585)
...
### fn `def cmd_rmstg(extra)` (L2590-2593)
...
### fn `def cmd_rmunt(extra)` (L2598-2601)
...
### fn `def cmd_rs(extra)` (L2606-2609)
...
### fn `def cmd_rssft(extra)` (L2614-2617)
...
### fn `def cmd_rsmix(extra)` (L2622-2625)
...
### fn `def cmd_rshrd(extra)` (L2630-2633)
...
### fn `def cmd_rsmrg(extra)` (L2638-2641)
...
### fn `def cmd_rskep(extra)` (L2646-2649)
...
### fn `def cmd_st(extra)` (L2654-2657)
...
### fn `def cmd_tg(extra)` (L2662-2665)
...
### fn `def cmd_unstg(extra)` (L2670-2673)
...
### fn `def cmd_wt(extra)` (L2678-2681)
...
### fn `def cmd_wtl(extra)` (L2686-2689)
...
### fn `def cmd_wtp(extra)` (L2694-2697)
...
### fn `def cmd_wtr(extra)` (L2702-2705)
...
### fn `def cmd_ver(extra)` (L2710-2736)
...
### fn `def cmd_chver(extra)` (L2741-2813)
...
### fn `def cmd_major(extra)` (L2822-2826)
...
### fn `def cmd_minor(extra)` (L2835-2839)
...
### fn `def cmd_patch(extra)` (L2848-2852)
...
### fn `def cmd_backup(extra)` (L2860-2870)
...
### fn `def cmd_changelog(extra)` (L2880-2912)
...
### fn `def print_command_help(name, width=None)` (L2992-2998)
...
### fn `def print_all_help()` (L3002-3036)
...
### fn `def main(argv=None, *, check_updates: bool = True)` (L3042-3092)
...
|`_format_changelog_description`|fn|priv|1027-1034|def _format_changelog_description(desc: str) -> str|
|`categorize_commit`|fn|pub|1041-1066|def categorize_commit(subject: str) -> Tuple[Optional[str...|
|`_extract_release_version`|fn|priv|1071-1081|def _extract_release_version(subject: str) -> Optional[str]|
|`_is_release_marker_commit`|fn|priv|1086-1089|def _is_release_marker_commit(subject: str) -> bool|
|`generate_section_for_range`|fn|pub|1098-1136|def generate_section_for_range(repo_root: Path, title: st...|
|`_get_remote_name_for_branch`|fn|priv|1145-1153|def _get_remote_name_for_branch(branch_name: str, repo_ro...|
|`_extract_owner_repo`|fn|priv|1160-1184|def _extract_owner_repo(remote_url: str) -> Optional[Tupl...|
|`_canonical_origin_base`|fn|priv|1194-1207|def _canonical_origin_base(repo_root: Path) -> Optional[str]|
|`get_origin_compare_url`|fn|pub|1214-1221|def get_origin_compare_url(base_url: Optional[str], prev_...|
|`get_release_page_url`|fn|pub|1227-1232|def get_release_page_url(base_url: Optional[str], tag: st...|
|`build_history_section`|fn|pub|1240-1244|def build_history_section(|
|`generate_changelog_document`|fn|pub|1288-1349|def generate_changelog_document(repo_root: Path, include_...|
|`VersionRuleContext`|class|pub|1360-1367|class VersionRuleContext|
|`_normalize_version_rule_pattern`|fn|priv|1373-1384|def _normalize_version_rule_pattern(pattern: str) -> str|
|`_build_version_file_inventory`|fn|priv|1390-1411|def _build_version_file_inventory(root: Path) -> List[Tup...|
|`_collect_version_files`|fn|priv|1419-1436|def _collect_version_files(root, pattern, *, inventory=None)|
|`_is_version_path_excluded`|fn|priv|1441-1444|def _is_version_path_excluded(relative_path: str) -> bool|
|`_iter_versions_in_text`|fn|priv|1450-1461|def _iter_versions_in_text(text, compiled_regexes)|
|`_read_version_file_text`|fn|priv|1468-1482|def _read_version_file_text(file_path: Path, text_cache: ...|
|`_prepare_version_rule_contexts`|fn|priv|1491-1492|def _prepare_version_rule_contexts(|
|`_determine_canonical_version`|fn|priv|1534-1541|def _determine_canonical_version(|
|`_parse_semver_tuple`|fn|priv|1586-1592|def _parse_semver_tuple(text: str) -> Optional[Tuple[int,...|
|`_replace_versions_in_text`|fn|priv|1599-1614|def _replace_versions_in_text(text, compiled_regex, repla...|
|`_current_branch_name`|fn|priv|1618-1630|def _current_branch_name()|
|`_ref_exists`|fn|priv|1635-1644|def _ref_exists(ref_name)|
|`_local_branch_exists`|fn|priv|1649-1652|def _local_branch_exists(branch_name)|
|`_remote_branch_exists`|fn|priv|1657-1660|def _remote_branch_exists(branch_name)|
|`_ensure_release_prerequisites`|fn|priv|1664-1691|def _ensure_release_prerequisites()|
|`_bump_semver_version`|fn|priv|1697-1715|def _bump_semver_version(current_version, level)|
|`_run_release_step`|fn|priv|1722-1742|def _run_release_step(level, step_name, action)|
|`_create_release_commit_for_flow`|fn|priv|1747-1752|def _create_release_commit_for_flow(target_version)|
|`_push_branch_with_tags`|fn|priv|1758-1762|def _push_branch_with_tags(branch_name)|
|`_execute_release_flow`|fn|priv|1778-1825|def _execute_release_flow(level, changelog_args=None)|
|`_execute_backup_flow`|fn|priv|1833-1848|def _execute_backup_flow()|
|`_run_release_command`|fn|priv|1854-1869|def _run_release_command(level, changelog_args=None)|
|`_run_backup_command`|fn|priv|1874-1881|def _run_backup_command()|
|`_run_reset_with_help`|fn|priv|1887-1894|def _run_reset_with_help(base_args, extra)|
|`_reject_extra_arguments`|fn|priv|1900-1906|def _reject_extra_arguments(extra, alias)|
|`_parse_release_flags`|fn|priv|1912-1930|def _parse_release_flags(extra, alias)|
|`_prepare_commit_message`|fn|priv|1936-1946|def _prepare_commit_message(extra, alias)|
|`_build_conventional_message`|fn|priv|1953-1967|def _build_conventional_message(kind: str, extra, alias: ...|
|`_run_conventional_commit`|fn|priv|1974-1979|def _run_conventional_commit(kind: str, alias: str, extra)|
|`_execute_commit`|fn|priv|1986-2015|def _execute_commit(message, alias, allow_amend=True)|
|`upgrade_self`|fn|pub|2019-2032|def upgrade_self()|
|`remove_self`|fn|pub|2036-2039|def remove_self()|
|`cmd_aa`|fn|pub|2044-2051|def cmd_aa(extra)|
|`cmd_ra`|fn|pub|2056-2079|def cmd_ra(extra)|
|`cmd_ar`|fn|pub|2084-2098|def cmd_ar(extra)|
|`cmd_br`|fn|pub|2103-2106|def cmd_br(extra)|
|`cmd_bd`|fn|pub|2111-2114|def cmd_bd(extra)|
|`cmd_ck`|fn|pub|2119-2122|def cmd_ck(extra)|
|`_ensure_commit_ready`|fn|priv|2127-2140|def _ensure_commit_ready(alias)|
|`cmd_cm`|fn|pub|2145-2150|def cmd_cm(extra)|
|`cmd_wip`|fn|pub|2155-2167|def cmd_wip(extra)|
|`cmd_release`|fn|pub|2172-2194|def cmd_release(extra)|
|`cmd_new`|fn|pub|2199-2202|def cmd_new(extra)|
|`cmd_refactor`|fn|pub|2207-2210|def cmd_refactor(extra)|
|`cmd_fix`|fn|pub|2215-2218|def cmd_fix(extra)|
|`cmd_change`|fn|pub|2223-2226|def cmd_change(extra)|
|`cmd_implement`|fn|pub|2231-2234|def cmd_implement(extra)|
|`cmd_docs`|fn|pub|2239-2242|def cmd_docs(extra)|
|`cmd_style`|fn|pub|2247-2250|def cmd_style(extra)|
|`cmd_revert`|fn|pub|2255-2258|def cmd_revert(extra)|
|`cmd_misc`|fn|pub|2263-2266|def cmd_misc(extra)|
|`cmd_cover`|fn|pub|2271-2274|def cmd_cover(extra)|
|`cmd_co`|fn|pub|2279-2282|def cmd_co(extra)|
|`cmd_d`|fn|pub|2287-2294|def cmd_d(extra)|
|`cmd_dcc`|fn|pub|2299-2302|def cmd_dcc(extra)|
|`cmd_dccc`|fn|pub|2307-2310|def cmd_dccc(extra)|
|`cmd_de`|fn|pub|2315-2318|def cmd_de(extra)|
|`cmd_di`|fn|pub|2323-2326|def cmd_di(extra)|
|`cmd_diyou`|fn|pub|2331-2334|def cmd_diyou(extra)|
|`cmd_dime`|fn|pub|2339-2342|def cmd_dime(extra)|
|`cmd_dwc`|fn|pub|2347-2350|def cmd_dwc(extra)|
|`cmd_dwcc`|fn|pub|2355-2358|def cmd_dwcc(extra)|
|`cmd_ed`|fn|pub|2363-2372|def cmd_ed(extra)|
|`cmd_fe`|fn|pub|2377-2380|def cmd_fe(extra)|
|`cmd_feall`|fn|pub|2385-2388|def cmd_feall(extra)|
|`cmd_gp`|fn|pub|2393-2396|def cmd_gp(extra)|
|`cmd_gr`|fn|pub|2401-2404|def cmd_gr(extra)|
|`cmd_str`|fn|pub|2409-2438|def cmd_str(extra)|
|`cmd_lb`|fn|pub|2443-2446|def cmd_lb(extra)|
|`cmd_lg`|fn|pub|2451-2464|def cmd_lg(extra)|
|`cmd_lh`|fn|pub|2469-2472|def cmd_lh(extra)|
|`cmd_ll`|fn|pub|2477-2489|def cmd_ll(extra)|
|`cmd_lm`|fn|pub|2494-2497|def cmd_lm(extra)|
|`cmd_lt`|fn|pub|2503-2522|def cmd_lt(extra)|
|`cmd_me`|fn|pub|2527-2530|def cmd_me(extra)|
|`cmd_pl`|fn|pub|2535-2538|def cmd_pl(extra)|
|`cmd_pt`|fn|pub|2543-2546|def cmd_pt(extra)|
|`cmd_pu`|fn|pub|2551-2554|def cmd_pu(extra)|
|`cmd_rf`|fn|pub|2559-2562|def cmd_rf(extra)|
|`cmd_rmtg`|fn|pub|2567-2577|def cmd_rmtg(extra)|
|`cmd_rmloc`|fn|pub|2582-2585|def cmd_rmloc(extra)|
|`cmd_rmstg`|fn|pub|2590-2593|def cmd_rmstg(extra)|
|`cmd_rmunt`|fn|pub|2598-2601|def cmd_rmunt(extra)|
|`cmd_rs`|fn|pub|2606-2609|def cmd_rs(extra)|
|`cmd_rssft`|fn|pub|2614-2617|def cmd_rssft(extra)|
|`cmd_rsmix`|fn|pub|2622-2625|def cmd_rsmix(extra)|
|`cmd_rshrd`|fn|pub|2630-2633|def cmd_rshrd(extra)|
|`cmd_rsmrg`|fn|pub|2638-2641|def cmd_rsmrg(extra)|
|`cmd_rskep`|fn|pub|2646-2649|def cmd_rskep(extra)|
|`cmd_st`|fn|pub|2654-2657|def cmd_st(extra)|
|`cmd_tg`|fn|pub|2662-2665|def cmd_tg(extra)|
|`cmd_unstg`|fn|pub|2670-2673|def cmd_unstg(extra)|
|`cmd_wt`|fn|pub|2678-2681|def cmd_wt(extra)|
|`cmd_wtl`|fn|pub|2686-2689|def cmd_wtl(extra)|
|`cmd_wtp`|fn|pub|2694-2697|def cmd_wtp(extra)|
|`cmd_wtr`|fn|pub|2702-2705|def cmd_wtr(extra)|
|`cmd_ver`|fn|pub|2710-2736|def cmd_ver(extra)|
|`cmd_chver`|fn|pub|2741-2813|def cmd_chver(extra)|
|`cmd_major`|fn|pub|2822-2826|def cmd_major(extra)|
|`cmd_minor`|fn|pub|2835-2839|def cmd_minor(extra)|
|`cmd_patch`|fn|pub|2848-2852|def cmd_patch(extra)|
|`cmd_backup`|fn|pub|2860-2870|def cmd_backup(extra)|
|`cmd_changelog`|fn|pub|2880-2912|def cmd_changelog(extra)|
|`COMMANDS`|var|pub|2915||
|`print_command_help`|fn|pub|2992-2998|def print_command_help(name, width=None)|
|`print_all_help`|fn|pub|3002-3036|def print_all_help()|
|`main`|fn|pub|3042-3092|def main(argv=None, *, check_updates: bool = True)|
